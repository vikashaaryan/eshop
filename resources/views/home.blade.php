   ...
   <div class="w-3/12 h-[60vh] border overflow-y-scroll scrollbar-hide p-3 rounded-xl shadow-sm bg-white">
    ...
    <div class="flex gap-2 flex-col">
        @foreach ($categories as $category)
            <a href="{{route("filter", $category->id)}}" class="flex justify-between items-center bg-gray-200 hover:bg-gray-300 transition p-2 rounded-md text-sm font-medium text-gray-700">
...
@empty
<h1 class="text-3xl font-semibold text-gray-300">Not Found</h1>
    @endforelse
</div>
